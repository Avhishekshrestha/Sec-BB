        ...
        <div class="container">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="lname" id="lname" class="form-control" placeholder="Last Name" aria-describedby="helpId">
            ...
            if(isset($_POST['submit'])){
              $to='sthaavhishke984@gmail.com';
                ...
                $query="insert into reservation(first_name, last_name, address, phone, email, activity) values('$first_name', '$last_name', '$address', '$phone', '$email', '$activity')";  
